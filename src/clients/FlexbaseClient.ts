...
export interface FlexbaseClient extends FlexbaseClientAddress, FlexbaseClientPlaid, FlexbaseCardsInvoice {}

applyMixins(FlexbaseClient, [FlexbaseClientAddress, FlexbaseClientPlaid, FlexbaseCardsInvoice]);
